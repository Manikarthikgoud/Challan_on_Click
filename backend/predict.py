...
def OCR(path,filename):
    ...
    cv2.imwrite('/backend/static/upload/'+filename,image_save)
    ...
    for i in range(0,n_coord):
        ...
        cv2.imwrite('/backend/static/predict_numberplate/'+str(i)+filename,image)
    ...
    # # 255 and all background pixels to 0
        ...
        cv2.imwrite('/backend/static/plates/'+str(i)+filename,sharp_image)
